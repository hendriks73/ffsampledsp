...
public class TestFFAudioFileReader {
  ...
  @Test
  public void testGetAudioFileFormatStemMP4File()
  ...
  /**
   * Try to load a file with a format that is unsupported. This test does not work properly, if mp3
  ...
  public void testGetAudioFileFormatLowProbeScoreFile2() throws IOException {
    // first copy the file from resources to actual location in temp
    final File file =
        new File("/Users/hendrik/downloads/The Early Access App [Questions #4688]/Oh My Love.abc");
    try {
  ...
  @Test
  public void testGetAudioFileFormatSpacesUmlautsPunctuation()
      throws IOException, UnsupportedAudioFileException {
    // first copy the file from resources to actual location in temp
    final String filename = "test.ogg";
    final File file;
    if (System.getProperty("os.name").toLowerCase().contains("win")) {
      file =
          File.createTempFile(
              "testGetAudioFileFormatSpacesAndUmlauts-t\u00fcst file [;&= @[]]", filename);
    } else {
      file =
          File.createTempFile(
              "testGetAudioFileFormatSpacesAndUmlauts-t\u00fcst file [;:&= @[]?]", filename);
  ...
  @Test
  public void testGetAudioFileFormatURLWithEmojis()
      throws IOException, UnsupportedAudioFileException {
    // first copy the file from resources to actual location in temp
    final String filename = "test.ogg";
  ...
  @Test
  public void testGetAudioFileFormatURLWithSpaces()
      throws IOException, UnsupportedAudioFileException {
    ...
    try {
      final AudioFileFormat fileFormat =
          new FFAudioFileReader()
              .getAudioFileFormat(new BufferedInputStream(new FileInputStream(file)));
      System.out.println(fileFormat);
  ...
  @Test
  public void testGetAudioFileFormatFile24bitWave()
      throws IOException, UnsupportedAudioFileException {
    // first copy the file from resources to actual location in temp
  ...
  @Test
  public void testGetAudioFileFormatFile24bitFLAC()
      throws IOException, UnsupportedAudioFileException {
    // first copy the file from resources to actual location in temp
